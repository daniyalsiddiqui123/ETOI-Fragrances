        ...
        >
          ...
          >
            <div className="p-8 text-center border-b border-gray-100">
              ...
              <h2 className="font-serif text-2xl text-etoi-primary mb-1">Order Confirmed!</h2>
              <p className="text-sm text-gray-400">Thank you for your purchase</p>
            </div>

            <div className="p-6 space-y-5">
              <div className="bg-etoi-cream/50 p-4 text-center">
                <p className="text-xs tracking-[0.15em] uppercase text-gray-400 mb-1">Order Number</p>
                <p className="font-mono text-sm text-etoi-primary font-medium">{orderNumber}</p>
              </div>
              ...
              {isBankTransfer && (
                <>
                  <div className="p-4 border border-gray-200 bg-etoi-cream/30 space-y-2 text-sm">
                  ...
                  <button
                    ...
                    className="w-full flex items-center justify-center gap-3 bg-green-600 text-white text-sm py-4 hover:bg-green-700 transition-colors"
                  >
